...
def get_most_similar(candidates, target_val, proxyService):
    """
    ...
    for cand in candidates:
        ...
        distances = [sDist.levenshtein(target_val, label) for label in cand['labels']]
        dist = min(distances)
    ...
    # popularity = proxyService.get_popularity_for_lst.send([cands_uris])
